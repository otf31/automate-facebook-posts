...
- **Id**: Show machine ID (for subscriptions)
...
The application verifies subscription status before allowing publications. Make sure you have an active subscription.
...
- 🌐 Web: https://autofbpost.sourceforge.net/
